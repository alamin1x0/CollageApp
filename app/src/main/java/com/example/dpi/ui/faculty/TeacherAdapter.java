...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.TeacherViewAdapter> {
    private List<com.example.dpi.ui.faculty.TeacherData> list;
    private Context context;

    public TeacherAdapter(List<com.example.dpi.ui.faculty.TeacherData> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull TeacherViewAdapter holder,  int position) {
        ...
        com.example.dpi.ui.faculty.TeacherData item = list.get(position);
